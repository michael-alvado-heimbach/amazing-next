...
*/ !(function(
  ...
  return (function e(t, n, r) {
    function o(c, s) {
      if (!n[c]) {
        if (!t[c]) {
          ...
          if (!s && a) return a(c, !0);
          if (i) return i(c, !0);
          const u = new Error(`Cannot find module '${c}'`);
    ...
    for (var i = typeof require === 'function' && require, c = 0; c < r.length; c++) o(r[c]);
    return o;
  })(
    {
      1: [
        function(e, t, n) {
          ...
          function i(e, t) {
            t = t || {};
            const n = t.successResponses || m.successResponses;
          ...
          function c(e, t, n) {
            const r = s.bind(null, e, t, n);
            d = d ? d.then(r) : r();
          }
          function s(e, t, n) {
            const o = e.url;
            const i = n.maxAgeSeconds;
            const c = n.maxEntries;
            const s = n.name;
            const a = Date.now();
            return (
              r(`Updating LRU order for ${o}. Max entries is ${c}, max age is ${i}`),
              g
                .getDb(s)
                .then(function(e) {
        ...
        function(e, t, n) {
          function r(e) {
            return new Promise(function(t, n) {
              const r = indexedDB.open(u + e, f);
              (r.onupgradeneeded = function() {
                const e = r.result.createObjectStore(h, { keyPath: p });
          ...
          function i(e, t, n) {
            return new Promise(function(r, o) {
              const i = e.transaction(h, 'readwrite');
              const c = i.objectStore(h);
          ...
          function c(e, t, n) {
            return t
              ? new Promise(function(r, o) {
                  const i = 1e3 * t;
                  const c = [];
                  const s = e.transaction(h, 'readwrite');
                  const a = s.objectStore(h);
                  const u = a.index(l);
      ...
      4: [
        function(e, t, n) {
          ...
          (r = self.registration ? self.registration.scope : self.scope || new URL('./', self.location).href),
            (t.exports = {
              cache: { name: `$$$toolbox-cache$$$${r}$$$`, maxAgeSeconds: null, maxEntries: null },
              debug: !1,
      ...
      5: [
        function(e, t, n) {
          const r = new URL('./', self.location);
          const o = r.pathname;
          const i = e('path-to-regexp');
          const c = function(e, t, n, r) {
            t instanceof RegExp
              ? (this.fullUrlRegExp = t)
              : (t.indexOf('/') !== 0 && (t = o + t), (this.keys = []), (this.regexp = i(t, this.keys))),
              (this.method = e),
              (this.options = r),
              (this.handler = n);
          };
        ...
        function(e, t, n) {
          ...
          ['get', 'post', 'put', 'delete', 'head', 'any'].forEach(function(e) {
            ...
            (s.prototype.add = function(e, t, n, c) {
              ...
              t instanceof RegExp
                ? (s = RegExp)
                : ((s = c.origin || self.location.origin), (s = s instanceof RegExp ? s.source : r(s))),
                (e = e.toLowerCase());
              const a = new o(e, t, n, c);
              this.routes.has(s) || this.routes.set(s, new Map());
              const u = this.routes.get(s);
              u.has(e) || u.set(e, new Map());
              const f = u.get(e);
              const h = a.regexp || a.fullUrlRegExp;
      ...
      11: [
        function(e, t, n) {
          function r(e, t, n) {
            n = n || {};
            const r = n.successResponses || o.successResponses;
            const c = n.networkTimeoutSeconds || o.networkTimeoutSeconds;
            return (
              ...
              i.openCache(n).then(function(t) {
                ...
                const u = [];
                if (c) {
                  const f = new Promise(function(r) {
                    s = setTimeout(function() {
                      t.match(e).then(function(e) {
                        const t = n.cache || o.cache;
                        const c = Date.now();
                        const s = t.maxAgeSeconds;
                ...
                const h = i
                  ...
                  .catch(function(r) {
                    return (
                      i.debug(`Network or response error, fallback to cache [${e.url}]`, n),
                      t.match(e).then(function(e) {
                        if (e) return e;
                        if (a) return a;
                        throw r;
      ...
      15: [
        function(e, t, n) {
          function r(e, t) {
            for (var n, r = [], o = 0, i = 0, c = '', s = (t && t.delimiter) || '/'; (n = x.exec(e)) != null; ) {
              const f = n[0];
              const h = n[1];
              const p = n.index;
          ...
          function s(e) {
            ...
            return function(n, r) {
              for (
                var o = '', s = n || {}, a = r || {}, u = a.pretty ? i : encodeURIComponent, f = 0;
                f < e.length;
                f++
              ) {
                const h = e[f];
                  ...
                  if (v(l)) {
                    ...
                    for (let d = 0; d < l.length; d++) {
                      if (((p = u(l[d])), !t[f].test(p)))
                        throw new TypeError(
                          `Expected all "${h.name}" to match "${h.pattern}", but received \`${JSON.stringify(p)}\``,
                        );
                      o += (d === 0 ? h.prefix : h.delimiter) + p;
                    }
                  } else {
          ...
          function m(e, t, n) {
            ...
            const l = a(n.delimiter || '/');
            const d = i.slice(-l.length) === l;
            return (
      ...
      16: [
        function(e, t, n) {
          !(function() {
            const e = Cache.prototype.addAll;
            const t = navigator.userAgent.match(/(Firefox|Chrome)\/(\d+\.)/);
            if (t) var n = t[1];
            const r = parseInt(t[2]);
            (e && (!t || (n === 'Firefox' && r >= 46) || (n === 'Chrome' && r >= 50))) ||
                      ...
                      return (
                        ...
                        Promise.all(
                          e.map(function(e) {
                            ...
                            if (n !== 'http:' && n !== 'https:') throw new t('Invalid scheme');
